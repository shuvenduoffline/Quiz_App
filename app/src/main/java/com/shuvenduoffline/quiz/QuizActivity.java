...
public class QuizActivity extends AppCompatActivity implements ScratchListener {
    ...
    private boolean isShowScractCard = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scratchCardLayout.setRevealFullAtPercent(60);
    ...
    public void onScratchComplete(){
        score += 5;
        final FrameLayout fm = findViewById(R.id.frame);
